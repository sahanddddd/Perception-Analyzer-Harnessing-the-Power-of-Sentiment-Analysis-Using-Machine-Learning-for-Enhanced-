...
app.layout = html.Div([
    ...
    html.Div(
        children=[
            html.H2('Perception Analyzer: Harnessing the Power of Sentiment Analysis Using Machine Learning for Enhanced Decision-Making', 
                    style={'color': 'white', 'padding': '1%', 'margin': '0 auto', 'font-family': 'Halden Solid'})
        ],
        style={'backgroundColor': '#5A00FF', 'text-align': 'center', 'width': '100%'}
    ),
    # Vertical bar
    html.Div(
        children=[
            html.H4("Introduction", style={'font-family': 'Halden', 'color': 'black', 'padding': '0%', 'text-align': 'left', 'margin-top': '0.2em', 'margin-bottom': '0em'}),
            html.P("This platform is a proof of concept for interface into a sentiment analysis tool that processes text inputs to determine their emotional tone. It utilizes a pre-trained machine learning model from Hugging Face's Transformers library and generates visual representations for better understanding. With adequate computing resources, data could be automatically pooled from news outlets and social media for real-time analysis and trend tracking, offering a broader insight into sentiment across diverse sources and over time. Copy & Past below text to the text input area to see how a more positive tweet changes the metrics: ", 
                    style={'font-family': 'Halden', 'font-size': '12px','color': 'black', 'padding': '0%', 'text-align': 'left', 'margin-top': '0.2em', 'margin-bottom': '0em'}),
            ...
            html.P("While there have been some improvements in the food security situation in Gooland. The progress made thus far is not sufficient. Urgent and sustained efforts are still required to ensure that all citizens have access to adequate nutrition. Some people are still struggling. However, some now have food. 🌍🙏 #GoolandStrong #FoodSecurity", 
                    style={'font-family': 'Halden', 'font-size': '12px', 'font-style' : 'italic' ,'color': 'grey', 'padding': '0%', 'text-align': 'left'}),
        ...
        style={'backgroundColor': '#E0E4FF', 'width': '15%', 'height': '100%', 'position': 'absolute', 'padding': '1%'}
    ),
    ...
    html.Div(
        children=[
            html.Div(
                children=[
                    html.A("GitHub", href="https://github.com/sahanddddd/Perception-Analyzer-Sentiment-Analysis-Using-Machine-Learning-for-Enhanced-Decision-Making.git", target="_blank", style={'font-family': 'Halden', 'font-size': '13px', 'color': 'white', 'display': 'inline-block', 'margin-left': '2em'}),
                    html.A("LinkedIn", href="https://www.linkedin.com/in/sahandsarbast", target="_blank", style={'font-family': 'Halden', 'font-size': '13px', 'color': 'white', 'display': 'inline-block', 'margin-left': '2em'})
                ],
                style={'display': 'inline-block', 'text-align': 'left', 'width': '50%', 'margin-left': '1em'}
            ),
            html.Div(
                children=[
                    html.P('Functional Prototype - Developed by Sahand Tahir', style={'font-family': 'Halden', 'font-size': '13px', 'color': 'white', 'display': 'inline-block', 'text-align': 'center', 'margin': '0'})
                ],
                style={'display': 'inline-block', 'text-align': 'center', 'width': '50%'}
            )
        ],
        style={'backgroundColor': '#5A00FF','display': 'flex', 'flex-direction': 'row','align-items':'center' , 'padding': '0', 'position': 'fixed', 'bottom': '0', 'height': '2em', 'width': '99%'}
    )
